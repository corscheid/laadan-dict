...
const AboutPage = () => (
  <Layout title="About">
    ...
    <p>
      This Láadan dictionary web app was created with the hope that anyone learning Láadan might find it useful.<br />
    ...
    <ul>
      <li>Developed by <a rel="noopener noreferrer" target="_blank" href="https://corscheid.dev">Corey Scheideman</a></li>
